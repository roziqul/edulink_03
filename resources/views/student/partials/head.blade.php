...
<head>
  ...
  <title>SmartLib - V1</title>
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('adminAssets/img/stisla.svg') }}">
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-colorpicker/3.1.1/css/bootstrap-colorpicker.min.css">
